  ...
  "node_modules/papaparse/papaparse.min.js"(exports, module) {
    ((e, t) => {
      ...
      function i2(m3) {
        ...
        function g3() {
          if (p4 && a2 && (k2("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + v.DefaultDelimiter + "'"), a2 = false), m3.skipEmptyLines && (p4.data = p4.data.filter(function(e3) {
            ...
            let t3 = function(e3, t4) {
              P(m3.transformHeader) && (e3 = m3.transformHeader(e3, t4)), c3.push(e3);
            };
            var t2 = t3;
        ...
        P(m3.step) && (t = m3.step, m3.step = function(e2) {
          ...
          var r3 = m3.quoteChar || '"', r3 = (m3.newline || (m3.newline = this.guessLineEndings(e2, r3)), a2 = false, m3.delimiter ? P(m3.delimiter) && (m3.delimiter = m3.delimiter(e2), p4.meta.delimiter = m3.delimiter) : ((r3 = ((e3, t3, i5, r4, n3) => {
            var s3, a3, o4, h3;
          ...
          l3 = true, s2.abort(), n2 = P(m3.chunk) ? "" : n2.substring(s2.getCharIndex());
        }, this.resume = function() {
          i3.streamer._halted ? (l3 = false, i3.streamer.parseChunk(n2, true)) : setTimeout(i3.resume, 3);
        }, this.aborted = function() {
          return e;
        }, this.abort = function() {
          e = true, s2.abort(), p4.meta.aborted = true, P(m3.complete) && m3.complete(p4), n2 = "";
        }, this.guessLineEndings = function(e2, t2) {
          e2 = e2.substring(0, 1048576);
          var t2 = new RegExp(M(t2) + "([^]*?)" + M(t2), "gm"), i4 = (e2 = e2.replace(t2, "")).split("\r"), t2 = e2.split("\n"), e2 = 1 < t2.length && t2[0].length < i4[0].length;
      ...
      function E2(C2) {
        var S = (C2 = C2 || {}).delimiter, O = C2.newline, x = C2.comments, I3 = C2.step, A3 = C2.preview, T3 = C2.fastMode, D = null, L = null == C2.quoteChar ? '"' : C2.quoteChar, F = L;
        if (void 0 !== C2.escapeChar && (F = C2.escapeChar), ("string" != typeof S || -1 < v.BAD_DELIMITERS.indexOf(S)) && (S = ","), x === S) throw new Error("Comment character same as delimiter");
        ...
        this.parse = function(i3, t, r2) {
          ...
          var n2 = i3.length, e = S.length, s2 = O.length, a2 = x.length, o3 = P(I3), h2 = [], u2 = [], d4 = [], f3 = j = 0;
          if (!i3) return b();
          if (T3 || false !== T3 && -1 === i3.indexOf(L)) {
            for (var l3 = i3.split(O), c3 = 0; c3 < l3.length; c3++) {
              if (d4 = l3[c3], j += d4.length, c3 !== l3.length - 1) j += O.length;
              else if (r2) return b();
              if (!x || d4.substring(0, a2) !== x) {
                if (o3) {
                  if (h2 = [], k2(d4.split(S)), R2(), z2) return b();
                } else k2(d4.split(S));
          ...
          for (var p4 = i3.indexOf(S, j), g3 = i3.indexOf(O, j), _3 = new RegExp(M(F) + M(L), "g"), m3 = i3.indexOf(L, j); ; ) if (i3[j] === L) for (m3 = j, j++; ; ) {
            if (-1 === (m3 = i3.indexOf(L, m3 + 1))) return r2 || u2.push({ type: "Quotes", code: "MissingQuotes", message: "Quoted field unterminated", row: h2.length, index: j }), E3();
            if (m3 === n2 - 1) return E3(i3.substring(j, m3).replace(_3, L));
            if (L === F && i3[m3 + 1] === F) m3++;
            else if (L === F || 0 === m3 || i3[m3 - 1] !== F) {
              ...
              if (i3.substr(m3 + 1 + y3, e) === S) {
                d4.push(i3.substring(j, m3).replace(_3, L)), i3[j = m3 + 1 + y3 + e] !== L && (m3 = i3.indexOf(L, j)), p4 = i3.indexOf(S, j), g3 = i3.indexOf(O, j);
                break;
              }
              y3 = v2(g3);
              if (i3.substring(m3 + 1 + y3, m3 + 1 + y3 + s2) === O) {
                if (d4.push(i3.substring(j, m3).replace(_3, L)), w2(m3 + 1 + y3 + s2), p4 = i3.indexOf(S, j), m3 = i3.indexOf(L, j), o3 && (R2(), z2)) return b();
                if (A3 && h2.length >= A3) return b(true);
                break;
              }
              u2.push({ type: "Quotes", code: "InvalidQuotes", message: "Trailing quote on quoted field is malformed", row: h2.length, index: j }), m3++;
            }
          }
          else if (x && 0 === d4.length && i3.substring(j, j + a2) === x) {
            if (-1 === g3) return b();
            j = g3 + s2, g3 = i3.indexOf(O, j), p4 = i3.indexOf(S, j);
          } else if (-1 !== p4 && (p4 < g3 || -1 === g3)) d4.push(i3.substring(j, p4)), j = p4 + e, p4 = i3.indexOf(S, j);
          else {
            if (-1 === g3) break;
            if (d4.push(i3.substring(j, g3)), w2(g3 + s2), o3 && (R2(), z2)) return b();
            if (A3 && h2.length >= A3) return b(true);
          }
          return E3();
          function k2(e2) {
          ...
          function E3(e2) {
            return r2 || (void 0 === e2 && (e2 = i3.substring(j)), d4.push(e2), j = n2, k2(d4), o3 && R2()), b();
          }
          function w2(e2) {
            j = e2, k2(d4), d4 = [], g3 = i3.indexOf(O, j);
          }
          function b(e2) {
            if (C2.header && !t && h2.length) {
              var s3 = h2[0], a3 = {}, o4 = new Set(s3);
              let n3 = false;
              for (let r3 = 0; r3 < s3.length; r3++) {
                let i4 = s3[r3];
                if (a3[i4 = P(C2.transformHeader) ? C2.transformHeader(i4, r3) : i4]) {
                  let e3, t2 = a3[i4];
            ...
            return { data: h2, errors: u2, meta: { delimiter: S, linebreak: O, aborted: z2, truncated: !!e2, cursor: f3 + (t || 0), renamedHeaders: D } };
          }
          function R2() {
            I3(b()), h2 = [], u2 = [];
          }
      ...
      function g2(e) {
        ...
        if (t.error) i3.userError(t.error, t.file);
          ...
          if (P(i3.userStep)) {
            ...
            delete t.results;
          } else P(i3.userChunk) && (i3.userChunk(t.results, n2, t.file), delete t.results);
        }
        t.finished && !r2 && _2(t.workerId, t.results);
      }
      function _2(e, t) {
        var i3 = o2[e];
        P(i3.userComplete) && i3.userComplete(t), i3.terminate(), delete o2[e];
      }
      function m2() {
      ...
      return v.parse = function(e, t) {
        ...
        P(i3) && (t.dynamicTypingFunction = i3, i3 = {});
        if (t.dynamicTyping = i3, t.transform = !!P(t.transform) && t.transform, !t.worker || !v.WORKERS_SUPPORTED) return i3 = null, v.NODE_STREAM_INPUT, "string" == typeof e ? (e = ((e2) => 65279 !== e2.charCodeAt(0) ? e2 : e2.slice(1))(e), i3 = new (t.download ? f2 : c2)(t)) : true === e.readable && P(e.read) && P(e.on) ? i3 = new p3(t) : (n.File && e instanceof File || e instanceof Object) && (i3 = new l2(t)), i3.stream(e);
        (i3 = (() => {
          var e2;
        ...
        })()).userStep = t.step, i3.userChunk = t.chunk, i3.userComplete = t.complete, i3.userError = t.error, t.step = P(t.step), t.chunk = P(t.chunk), t.complete = P(t.complete), t.error = P(t.error), delete t.worker, i3.postMessage({ input: e, config: t, workerId: i3.id });
        ...
        function e() {
          if (0 === h2.length) P(o3.complete) && o3.complete();
          else {
            var e2, t, i4, r2, n2 = h2[0];
            if (P(o3.before)) {
              var s2 = o3.before(n2.file, n2.inputElem);
              if ("object" == typeof s2) {
                if ("abort" === s2.action) return e2 = "AbortError", t = n2.file, i4 = n2.inputElem, r2 = s2.reason, void (P(o3.error) && o3.error({ name: e2 }, t, i4, r2));
...
papaparse/papaparse.min.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-Y7LN4AC6.js.map
